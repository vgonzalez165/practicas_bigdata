...
En este [notebook de Jupyter](./Gráficas_estadísticas.ipynb) puedes ver algunos ejemplos de como obtener gráficas de datos para comprobar visualmente los datos que obtenemos de las estadísticas.