...
2. **Actividad:** la `categoria_actividad` debe contener la palabra "Bodegas" (investiga [`like`](https://spark.apache.org/docs/latest/api/python/reference/pyspark.sql/api/pyspark.sql.Column.like.html)).
